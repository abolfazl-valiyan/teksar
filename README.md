...
```
cd existing_repo
git remote add origin https://hamgit.ir/abolfazlvalian546/teksar.git
git branch -M main
...
- [ ] [Set up project integrations](https://hamgit.ir/abolfazlvalian546/teksar/-/settings/integrations)
